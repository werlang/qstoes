...
function showAlteracoes() {
    $("#alteracoes").addClass('visible');
    setTimeout(() => $("#alteracoes").addClass('fade-in'), 10);
}
...
function bind_questoes(){
    ...
    $('.rounded-list li').click( function(e){
        if (!$('.rounded-list li.active').length){
            cancela_alteracoes(texto_original, old_src, old_res);
            ...
            document.addEventListener("click", function closeMenu(e) {
                if (e.target.closest("li.active") === null && e.target.closest(".e-button-container") === null) {
