	...
	<div id='frame-wrapper'>
		<div id='frame'>
			...
			<div id='opcoes' class='linha e-button-container'>
				<div id='texto' class='e-button' title='Alterar texto'>
					<img src='icon/texto.png'>
				</div>
				<div id='assuntos' class='e-button' title='Alterar assuntos'>
					<img src='icon/assuntos.png'>
				</div>
				<div id='imagem' class='e-button' title='Alterar imagem'>
					<img src='icon/imagem.png'>
				</div>
				<div id='resolucao' class='e-button' title='Alterar resoluções'>
					<img src='icon/upload_round.png'>
				</div>
				<div id='apagar' class='e-button' title='Apagar questão'>
					<img src='icon/x.png'>
				</div>
			</div>
