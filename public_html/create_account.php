                ...
                if ($_POST['sobrenome'] == "")
                    ...
                    if (strlen($_POST['new-pass']) < 6 || !ctype_alnum($_POST['new-pass']))
                        ...
                        if ($confirmpass != $newpass)
                            ...
                            if ($nrows == 0){
                                $sql = "INSERT INTO professores (email,nome,sobrenome,senha,lattes,titulo,instituicao,facebook,twitter,linkedin,ativo) VALUES ('$email','$nome','$sobrenome','". md5($newpass) ."','$lattes','$titulo','$instituicao','$facebook','$twitter','$linkedin','1')";
                            ...
                            //  Verifique o email informado para instruções de ativação da conta.";
